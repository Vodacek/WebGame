...
Bridge.define('Game3D.Helpers.Vector2', {
    statics: {
        ...
        distanceFrom: function (a, b) {
            return Bridge.cast(Bridge.get(Math).sqrt((a.x - b.x) * (a.x - b.x) + (a.y - b.y) * (a.y - b.y)), Number);
        }/**
         * operator +
         *
         * @static
     ...
     */
    getLength: function () {
        return Bridge.cast(Bridge.get(Math).sqrt(this.x * this.x + this.y * this.y), Number);
    },
    /**
     ...
     */
    toString: function () {
        return Bridge.String.format("Float2: {0}, {1}", this.x, this.y);
    },
    getHashCode: function () {
        var hash = 17;
...
Bridge.define('Game3D.Helpers.Vector3', {
    statics: {
         ...
         */
        distanceFrom: function (a, b) {
            return Bridge.cast(Bridge.get(Math).sqrt((a.x - b.x) * (a.x - b.x) + (a.y - b.y) * (a.y - b.y) + (a.z - b.z) * (a.z - b.z)), Number);
        }/**
         * operator +
         *
         * @static
     ...
     */
    getLength: function () {
        return Bridge.cast(Bridge.get(Math).sqrt(this.x * this.x + this.y * this.y + this.z * this.z), Number);
    },
    /**
     * Returns normalized vector
     *
     ...
     */
    toString: function () {
        return Bridge.String.format("Float2: {0}, {1}, {2}", this.x, this.y, this.z);
    },
    getHashCode: function () {
        var hash = 17;
        hash = hash * 23 + (this.x == null ? 0 : Bridge.getHashCode(this.x));
